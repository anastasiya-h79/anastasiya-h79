...
В анализе данных проработала более 5 лет. Опыт работы в интернет-маркетинге - более 9 лет: smm -> контекстная реклама -> комплексный интернет-маркетинг. Люблю и умею правильно разработать и оптимизировать рекламные кампании и инструменты анализа трафика с целью достижения KPI. 

Владею SQL, Python, библиотеками для анализа данных. Python-разработку и Python для анализа данных изучала в Университете искусственного интеллекта. Есть опыт разработки нейросетей (CV). 
